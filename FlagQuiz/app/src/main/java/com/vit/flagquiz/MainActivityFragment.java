...
public static String numberButtons;
public static String pressButText;
public static String textButWithCorrectAnswer;
...
public static TextView answer_tv;
...
public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
    ...
    guess_tv=(TextView)view.findViewById(R.id.guess_tv);
    ...
    question_number=getString(R.string.question, 1, FLAGS_IN_QUIZ);
    question_number_tv.setText(question_number);
    return view;
}

public void updateVariant(SharedPreferences sharedPreferences) {
    numberButtons = sharedPreferences.getString(MainActivity.CHOICES, null);
    Rows = Integer.valueOf(numberButtons) / 2;
...
private void loadNextFlag() {
    ...
    answer_tv.setText("");
    count = 0;
    question_number=getString(R.string.question, (correctAnswers + 1), FLAGS_IN_QUIZ);
    question_number_tv.setText(question_number);
    ...
    textButWithCorrectAnswer=getCountryName(correctAnswer);
...
private View.OnClickListener ButListener = new View.OnClickListener() {
    ...
    public void onClick(View v) {
        ...
        pressButText = pressBut.getText().toString();
